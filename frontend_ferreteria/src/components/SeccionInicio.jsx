  ...
  return (
    <>
      ...
      <div style={{ width: '100%', backgroundColor: '#fff', borderBottom: '3px solid #fcee21', padding: '40px 5%', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
        ...
        {/* Uso de clamp() para texto responsivo: Mínimo 28px, ideal 5vw, Máximo 42px */}
        <h2 style={{ fontSize: 'clamp(28px, 5vw, 42px)', margin: '0 0 15px 0', color: '#000', fontWeight: '900', lineHeight: '1.1' }}>
          El mayor surtido ferretero
        </h2>
        <p style={{ fontSize: 'clamp(16px, 3vw, 20px)', margin: '0 0 25px 0', color: '#555', maxWidth: '800px', lineHeight: '1.5' }}>
          Encuentra todo lo que necesitas para tu proyecto en Guayaquil, con el respaldo de las mejores marcas del mercado.
        </p>
        
        {/* Scroll dinámico que baja exactamente la altura de la pantalla actual */}
        <button 
          onClick={() => window.scrollBy({ top: window.innerHeight * 0.8, behavior: 'smooth' })} 
          style={{ padding: '15px 30px', backgroundColor: '#000', color: '#fcee21', border: 'none', borderRadius: '4px', fontWeight: 'bold', cursor: 'pointer', fontSize: '16px', textTransform: 'uppercase', letterSpacing: '1px' }}
        >
          Explorar Productos
        </button>
      </div>
      ...
      <div style={{ backgroundColor: '#fff', padding: '40px 5%', borderBottom: '2px solid #eee' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '25px', flexWrap: 'wrap' }}>
          ...
          <span onClick={() => seleccionarCategoria('Todas las categorías')} style={{ color: '#0066cc', cursor: 'pointer', fontWeight: 'bold', fontSize: '14px', marginTop: '5px' }}>Ver todos</span>
        </div>
      ...
      <div style={{ backgroundColor: '#000', padding: '30px 5%', color: '#fff', borderBottom: '3px solid #fcee21' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '15px' }}>
          <div>
            <h2 style={{ margin: 0, fontSize: 'clamp(20px, 4vw, 26px)', fontWeight: 'bold', color: '#fcee21' }}>Descubre nuestras ofertas exclusivas</h2>
        ...
        {/* Ajuste del minmax a 260px para mayor compatibilidad con celulares pequeños */}
